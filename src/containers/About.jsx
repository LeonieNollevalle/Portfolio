...
<h1>HI,</h1>
<p>
Je possède un intérêt particulier en design graphique pour la typographie ainsi que l’édition auxquelles j’aime insuffler une identité. Expérimenter et transposer ces intérêts dans des interfaces numériques et les faire dialoguer avec des supports print sont des choses que j'affectionne particulièrement.<br/>
<br/>
D’autre part, j’apprécie travailler à partir de contraintes techniques afin de les transcender et donner des réponses justes et créatives. Ces contraintes techniques viennent parfois ajouter une part de hasard et de perte de contrôle que j’aimerai davantage expérimenter, notamment dans le numérique. En dehors du Design graphique, la mode est un des champs du design qui m’intéresse à travers le traitement des textures et des formes présentées dans des univers intéressants à observer. Surtout du point de vue photographique, les images produites par la mode peuvent être une grande source d’inspiration.
 ...
 <div className="container-info">
  ...
  <h3>Stage//2022</h3>
  <p>Réalisé chez Jocelyn Richard sur le site flownaely avec lequel j’ai pu développer l’expérience utilisateur de flownaely, son l’identité visuelle ainsi que son intégration web.</p>
  <h3>Workshop//2018</h3>
  ...
  <h3>Auto-entreprenaria//2021</h3>
  <p>Réalisation de maquette et d’univers graphique pour le site flownaely créé par jocelyn richard.</p>
  <h2>Cursus</h2>
