...
const Interfaces = [
  ...
  },
  {
    ...
    descritpion:"Dans le cadre de mon projet de fin d'étude il m'a été proposé de réaliser une identité visuelle, une communication ainsi qu'un site web pour un professionnel de la dermographie",
...
"https://freight.cargo.site/t/original/i/d29241e5e3904f1f31a190151307b47712ed944af23f8dca4c66d08482a42864/insta13.jpg"],
    liensProto:"https://xd.adobe.com/view/069b8600-f933-4349-b062-08aae401d9aa-53c8/screen/5b2bd59b-f3f9-4b57-ac69-006f3a008c18/",
  ...
  },
  {
    ...
    descritpion:"Création d'un site web autour du cinéma, proposant un large choix de suggestion de film aléatoire. Afin de sortir du model des grandes platformes de streaming qui noie l'utilisiteur dans un grand nombre de contenue",
...
liensProto:"https://xd.adobe.com/view/73c92571-c22f-45dd-81bd-f07c178177e9-269a/"
  },
  {
    ...
    date:2021,
    catégorie:"Site Web",
    technique:"Appli web déployé",
    descritpion:"Création d'un site web autour de la musique durant un hackathon. Ça fonctionnalité principla étant de faire de faire la promotion d'artiste peu connu, en proposant à l'utilisateur d'écouter des playlists par genre de ces derniers.",
  ...
  },
  {
    ...
    catégorie:"Site Web",
    technique:"Prototype numérique/motion",
    descritpion:"Site web réalisé pour le musée de Bretagne, une expérience proposant un aperçu de la collection du musée autour du vêtement, dans diverses catégories telles que le vêtement de travail.",
  ...
  },
  {
    ...
    descritpion:"Création d'une fonctionnalité web pour le site ManoMano durant un hackathon. Cette fonctionnalité consiste à aider les personnes novice en bricolage, en leur créant automatiquement des paniers d'achats en fonction des travaux qu'il souhaite réaliser.",
