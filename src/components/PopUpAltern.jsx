...
const PopUpAltern = ({handlPop}) => {
  ...
  <div className="container-popup-Alt">
    ...
    <p>Je suis actuellement à la recherche d'une alternance dans le domaine du web, notamment dans une entreprise qui possède au sein de son équipe des professionnel d'ux, ui Design ou du web Design de manière plus généralement. :)</p>
